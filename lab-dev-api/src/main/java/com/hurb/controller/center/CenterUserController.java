...
public class CenterUserController extends BaseController {
    ...
    public HURBJSONResult uploadFace(
...
//        String fileSpace = IMAGE_USER_FACE_LOCATION;
        ...
        if (file != null) {
            ...
            try {
                ...
                if (StringUtils.isNotBlank(fileName)) {
                    ...
                    // 文件重命名  hurb-face.png -> ["hurb-face", "png"]
                    ...
                    if (!suffix.equalsIgnoreCase("png") &&
                        ...
                        return HURBJSONResult.errorMsg("图片格式不正确！");
                    }
            ...
            return HURBJSONResult.errorMsg("文件不能为空！");
        }
    ...
    public HURBJSONResult update(
        ...
        if (result.hasErrors()) {
            ...
            return HURBJSONResult.errorMap(errorMap);
        }
